...
browser_control
  action: "go_to" | "search" | "click" | "type" | "scroll" | "get_text" | "press" | "eval_js" | "close" (required)
  browser: "chrome" | "brave" | "edge" | "firefox" | "opera" | "operagx" | "vivaldi" | "safari" (optional)
  profile: string (optional, e.g. "Default", "Profile 1", "BOSS")
  url: string (for go_to)
  query: string (for search)
  text: string (for click/type)
  direction: "up" | "down" (for scroll)
  script: string (JavaScript code string for eval_js)
